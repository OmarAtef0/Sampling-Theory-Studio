...
class SamplingStudioApp(QMainWindow):
  def __init__(self):
    ...
    self.ui.sampling_PushButton.clicked.connect(lambda: composer.move_sinusoidal_to_sampling(self,plot_name="Primary"))
    # self.ui.sampling_PushButton.clicked.connect(lambda: composer.move_signal_to_plot(self,plot_name="Error"))
    # self.ui.sampling_PushButton.clicked.connect(lambda: composer.move_signal_to_plot(self,plot_name="Secondary"))
